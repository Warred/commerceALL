...
export const ClientUpdate = (props: IClientUpdateProps) => {
  ...
  const { clientEntity, users, adresses, loading, updating } = props;
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="commerceApp.client.home.createOrEditLabel">Create or edit a Client</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : clientEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                ...
                <AvInput id="client-adresse" type="select" className="form-control" name="adresseId">
                  <option value="" key="0" />
                  {adresses
